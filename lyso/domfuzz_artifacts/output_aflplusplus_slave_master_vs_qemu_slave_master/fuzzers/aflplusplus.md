...
<div class="section">
    ...
    <h2>libsndfile</h2>
        ...
        <div class="row">
            ...
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_libsndfile_sndfile_fuzzer_reached.svg">
            </div>
        
            
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_libsndfile_sndfile_fuzzer_triggered.svg">
            </div>
    ...
    <h2>libxml2</h2>
        ...
        <div class="row">
            ...
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_libxml2_libxml2_xml_read_memory_fuzzer_reached.svg">
            </div>
        
            
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_libxml2_libxml2_xml_read_memory_fuzzer_triggered.svg">
            </div>
        ...
        <div class="row">
            ...
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_libxml2_xmllint_reached.svg">
            </div>
        
            
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_libxml2_xmllint_triggered.svg">
            </div>
    ...
    <h2>lua</h2>
        ...
        <div class="row">
            ...
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_lua_lua_reached.svg">
            </div>
        
            
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_lua_lua_triggered.svg">
            </div>
    ...
    <h2>openssl</h2>
        ...
        <div class="row">
            ...
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_openssl_asn1_triggered.svg">
            </div>
    ...
    <h2>sqlite3</h2>
        ...
        <div class="row">
            ...
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_sqlite3_sqlite3_fuzz_reached.svg">
            </div>
        
            
            <div class="col s6">
                <img class="materialboxed responsive-img" src="../plot/box_aflplusplus_sqlite3_sqlite3_fuzz_triggered.svg">
            </div>
